...
class Modal extends Component {
   ...
   changeHandler = event => {
     storage().ref('dogImages').child(sessionStorage.getItem("imageName")).getDownloadURL().then(url => {
          this.setState({ ...this.state.formControls.imageLink.value[0].url= url });
          //console.log(this.state.formControls.imageLink.value) 
      });

    AsyncStorage.getItem("location").then((loc=>{
        this.setState({...this.state.formControls.location.value= loc})
    }));
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form className="form-popup">
                                    ...
                                    <input type="hidden" id="likesCount" name="likesCount" value={this.state.formControls.likesCount.value} />
